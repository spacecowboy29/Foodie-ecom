...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=AQjTyGvofSsXHttlY6K9PwtjW6-nlydXXb1WwYZ99heU44R6qVEQvKZN0uSkbJIMnzxIjqjQHbzJh9Tq"></script>
    <script>
        paypal.Buttons({
            createOrder: function (data, actions) {
                return actions.order.create({
                    purchase_units: [{
                        amount: {
                            value: document.getElementById('<%= orderTotalHidden.ClientID %>').value
                        }
                    }]
                });
            },
            onApprove: function (data, actions) {
                return actions.order.capture().then(function (details) {
                    // Capture the payer's name and set it to a hidden field
                    document.getElementById('<%= hiddenPayerName.ClientID %>').value = details.payer.name.given_name + ' ' + details.payer.name.surname;

                    // Handle the server-side order capture here
                    // Manually trigger the lbPayPalSubmit_Click event
                    document.getElementById('<%= lbPayPalSubmit.ClientID %>').click();
                });
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="book_section" style="background-image: url('../assets/images/bg.jpg'); width: 100%; height: 100%; background-repeat: no-repeat; background-size: auto; background-attachment: fixed; background-position: left;">
            ...
            <div class="row pb-5">
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="paypal" class="tab-pane fade show active pt-3">
                                    ...
                                    <div class="form-group ">
                                        <label for="txtPaypalAddress">
                                            <h6>Delivery Address</h6>
                                        </label>
                                        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                        <asp:HiddenField ID="orderTotalHidden" runat="server" />
                                        <asp:HiddenField ID="hiddenPayerName" runat="server" />

                                        <asp:TextBox ID="txtPaypalAddress" runat="server" CssClass="form-control" placeholder="Delivery Address"
                                            TextMode="MultiLine"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvPaypalAddress" runat="server" ErrorMessage="Address is required" ForeColor="Red"
                                            ControlToValidate="txtPaypalAddress" Display="Dynamic" SetFocusOnError="true" ValidationGroup="paypal"
                                            Font-Names="Arial"></asp:RequiredFieldValidator>
                                    </div>


                                    <h6 class="pb-2">Select Your Paypal Account Type</h6>
                                    <asp:LinkButton ID="lbPayPalSubmit" runat="server"
                                        ValidationGroup="paypal" OnClick="lbPayPalSubmit_Click" Visible="true">
                                ...
                                <div id="cod" class="tab-pane fade pt-3">
                                    ...
                                    <p>
                                    <p>
                                        <asp:LinkButton ID="lblCodSubmit" runat="server" CssClass="btn btn-info" ValidationGroup="cod" OnClick="lbCodSubmit_Click">
                        ...
                        <div class="card-footer">
                            <b class="badge badge-success badge-pill shadow-sm total-badge">Order Total: ₱<% Response.Write(Session["grandTotalPrice"]); %> 
                            </b>
                            <div class="pt-1">
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" ValidationGroup="card"
                                    HeaderText="Fix the Following Errors" Font-Names="sans-serif" />
                            </div>
                        </div>
                    </div>
                </div>
