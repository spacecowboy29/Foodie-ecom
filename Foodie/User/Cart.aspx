...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    padding: 10px 20px !important; /* Improves button size */
    text-align: center !important; /* Ensures proper alignment */
    display: inline-flex !important; /* Aligns icon and text properly */
    align-items: center !important; /* Centers content vertically */
    justify-content: center !important; /* Centers text properly */
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove" 
                                    ...
                                    OnClientClick="return confirm('Do you want to delete this item from cart?');"> 
                ...
                <FooterTemplate>
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Menu.aspx" class="btn btn-info custom-btn"> <i class="fa fa-arrow-circle-left mr-2"></i>Continue Shopping</a>
                        </td>
                        <td>
                            <asp:LinkButton ID="lbUpdateCart" runat="server" CommandName="updateCart" CssClass="btn btn-warning custom-btn">
                                <i class="fa fa-refresh mr-2"></i>Update Cart
                            </asp:LinkButton>
                        </td>
                        <td>
                            <asp:LinkButton ID="lbCheckout" runat="server" CommandName="checkout" CssClass="btn btn-success custom-btn">
